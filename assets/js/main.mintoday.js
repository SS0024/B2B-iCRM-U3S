...
function get_item_preview_values() {
    var e = {};
    return e.description = $('.main textarea[name="description"]').val(), e.long_description = $('.main textarea[name="long_description"]').val(), e.qty = $('.main input[name="quantity"]').val(), e.taxname = $(".main select.tax").selectpicker("val"), e.item_amount = $('.main input[name="item_amount"]').val(), e.rate = $('.main input[name="rate"]').val(), e.unit = $('.main input[name="unit"]').val()
}
...
function calculate_total() {
    ...
    var e, t, a, i, n, s, o = {},excel_amount = {},item_qty = {},tax_rates  = {},
		...
		if(typeof(k) != 'undefined' && k > 0 ){
			alert("amount "+excel_amount[e]);
			alert("qty "+item_qty[e]);
			...
			var item_packaging_forwording = (((k/l)*(excel_amount[e]*item_qty[e])) + excel_amount[e]*item_qty[e])
			d = d + parseFloat(item_packaging_forwording - (excel_amount[e]*item_qty[e]));
            //d = d + 
			alert(item_packaging_forwording);
			var new_tax = item_packaging_forwording  * tax_rates[e] / 100;
			alert(new_tax);
	...
	if(typeof(devide_gst) != 'undefined' && devide_gst === "yes"){
		 ...
		 if(total_calculated_tax != 0){
			 gst_tax = (total_calculated_tax/2)*2;
		 }
		 ...
		 if(gst_tax_rate != 0){
			 ...
			 tax_row += '<tr class="gst-tax-area"><td>SGST('+accounting.formatNumber(gst_tax_rate)+'%)</td><td id="tax_id_SGST">'+accounting.formatNumber(gst_tax)+'</td></tr>';
