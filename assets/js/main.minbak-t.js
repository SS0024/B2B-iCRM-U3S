...
function calculate_total() {
    ...
    //             alert(e);
        ...
        // if(typeof(k) != 'undefined' && k != 0 ){
        //      total_tax_percentage = total_tax_percentage + packing_and_forwarding;
        //      var service_charge_tax1 =  k * packing_and_forwarding / 100;
        //      total_calculated_tax = total_calculated_tax + service_charge_tax1;
             
             
        //      tax_summery_row = '<tr class="tax-summery-row"><td>'+summry_row_number+'</td><td>GST@' + packing_and_forwarding + "%(" + packing_and_forwarding + '%)</td><td>GST@' + packing_and_forwarding + "%(" + packing_and_forwarding + '%)</td><td id="qty_id_service_charges">1</td><td id="excel_amount_id_service_charges">'+k+'</td><td id="tax_id_service_charges">'+total_calculated_tax+'</td></tr>',
        //      $(tax_summry_area_body).append(tax_summery_row),
        //      summry_row_number += 1;
        //      d += total_calculated_tax;      
