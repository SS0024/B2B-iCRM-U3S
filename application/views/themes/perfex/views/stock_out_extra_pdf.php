...
$info_right_column .= '<span style="font-weight:bold;font-size:27px;">' . _l('Stock Out') . '</span><br />';
...
$invoice_info .= '<br />' . _l('Invoice Date') . ':- ' . _d($invoice->date) . '<br />';
...
$items_data = get_stock_table_items($invoice->items, 'stock_out_extra');
