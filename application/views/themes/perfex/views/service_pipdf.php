...
$info_right_column .= '<span style="font-weight:bold;font-size:27px;">Service Pi</span><br />';
...
$items_data = get_table_items_and_taxes($invoice->items, 'service_pi',true,$invoice->is_bulk,$isDiscountDisplay);
