                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table items">
                            ...
                            <tbody>
                               <?php
                                   $items_data = get_table_items_and_taxes($invoice->items,'invoice',false, $invoice->is_bulk); 
                ...
                <table class="table text-right">
                    <tbody>												
						...
						<?php //if((int)$invoice->packing_and_forwarding != 0){ ?>						 
							<tr>							 
								<td><span class="bold"><?php echo _l('estimate_packing_and_forwarding'); ?></span>							</td>							  
						...
						<tr>							 
							<td> <span class="bold"><?php echo _l('estimate_servicecharge'); ?></span>							 
							</td>							 
						...
						<!-- <tr>							  
							<td><span class="bold"><?php //echo _l('estimate_transportation'); ?></span></td>							  
							<td class="transportation"><?php //echo format_money($invoice->transportation,$invoice->symbol); ?></td>						   
						</tr> -->						   
					<?php //} ?>	
                        ...
                        <?php
						// if(isset($invoice->servicecharge) && $invoice->servicecharge > 0 && !empty($invoice->service_charge_tax_rate) && $invoice->service_charge_tax_rate != 0){ 
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><?php echo format_money($service_charge_tax,$invoice->symbol); ?></td>
												</tr>
