<div id="proposal-wrapper">
   ...
   <table class="table items no-margin">
      ...
      <tbody>
         <?php
            $items_data = get_table_items_and_taxes($proposal->items,'proposal',false,$proposal->is_bulk);
         ...
         <table class="table text-right">
            <tbody>
			 ...
			 <tr id="subtotal">
               ...
               <?php } ?>
			 <?php //if((int)$proposal->transportation != 0){ ?>
               <!--<tr>
                  <td>
                     <span class="bold"><?php //echo _l('estimate_transportation'); ?></span>
                  </td>
                  <td class="transportation">
                     <?php //echo format_money($proposal->transportation,$proposal->symbol); ?>
                  </td>
               </tr>-->
               <?php //} ?>
			    <?php //if((int)$proposal->packing_and_forwarding != 0){ ?>
               <tr>
                  <td>
               ...
               <?php //} ?>
			   <?php //if((int)$proposal->servicecharge != 0){ ?>
               <tr>
                  <td>
			   ...
			   <?php
			   // if(isset($proposal->servicecharge) && $proposal->servicecharge > 0 && !empty($proposal->service_charge_tax_rate) && $proposal->service_charge_tax_rate != 0){ 
				// $service_charge_tax = $proposal->servicecharge*$proposal->service_charge_tax_rate /100;
							
				// echo '<tr class="tax-area"><td class="bold">GST@'.$proposal->service_charge_tax_rate.'% ('._format_number($proposal->service_charge_tax_rate).'%)</td><td>'.format_money($service_charge_tax, $proposal->symbol).'</td></tr>';
			  // }	
			   ?>
