...
$info_right_column .= '<span style="font-weight:bold;font-size:27px;">Service ' . _l('invoice_pdf_heading') . '</span><br />';
...
$items_data = get_table_items_and_taxes($invoice->items, 'service_invoice',true,$invoice->is_bulk,$isDiscountDisplay);
...
if (count($invoice->payments) > 0 && get_option('show_total_paid_on_invoice') == 1) {
    ...
    <tr>
        ...
        <td align="right" width="15%">-' . format_money(sum_from_table('tblinvoiceservicepaymentrecords', [
        'field' => 'amount',
        'where' => [
