<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <a href="<?php echo admin_url('service_invoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list">
         ...
         <div class="display-block text-right">
            ...
            <a href="#"
              ...
              onclick="toggle_small_view('.table-service_invoices','#service_invoice'); return false;"
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/service_invoices/recurring/table_html'); ?>
            </div>
         </div>
      </div>
