<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons erer">
         <?php $this->load->view('admin/service_invoices/invoices_top_stats'); ?>
         <?php if(has_permission('service_invoices','','create')){ ?>
            <a href="<?php echo admin_url('service_invoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('Create New Service Invoice'); ?></a>
         <?php } ?>

<!--         <a href="--><?php //echo admin_url('service_invoices/recurring'); ?><!--" class="btn btn-info pull-left">--><?php //echo _l('invoices_list_recurring'); ?><!--</a>-->
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/service_invoices/table_html'); ?>
            </div>
         </div>
      </div>
