        ...
        <div class="row">
            <div id="merge" class="col-md-6">
                <?php if (isset($invoice)) {
                    $this->load->view('admin/service_invoices/merge_invoice', array('invoices_to_merge' => $invoices_to_merge));
                } ?>
            </div>
            ...
            <?php if (!isset($invoice_from_project)) { ?>
                <div id="expenses_to_bill" class="col-md-6">
                    <?php if (isset($invoice) && $invoice->status != 5) {
                        $this->load->view('admin/service_invoices/bill_expenses', array('expenses_to_bill' => $expenses_to_bill));
                    } ?>
                </div>
            <?php } ?>
        </div>
...
<div class="panel_s invoice accounting-template">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php include_once(APPPATH . 'views/admin/service_invoices/billing_and_shipping_template.php'); ?>
                    </div>
                    <div class="col-md-6">
              ...
              <span class="shipping_street">
                ...
                <?php
                $next_invoice_number = get_option('next_service_invoice_number');
                $format = get_option('service_invoice_number_format');
                if (isset($invoice)) {
                    $format = $invoice->number_format;
                }
                $prefix = get_option('service_invoice_prefix');
                if ($format == 1) {
            ...
            <span id="prefix_year" class="format-mm-yyyy"><?php echo $yyyy; ?></span>
                ...
                ?>
                <?php echo render_custom_fields('service_invoice', $rel_id); ?>
            </div>
            <div class="col-md-6">
    ...
    <!--  -->
    <?php $this->load->view('admin/service_invoices/_add_edit_items'); ?>
