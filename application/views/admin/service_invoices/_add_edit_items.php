...
<!--            --><?php //$this->load->view('admin/invoice_items/item_select'); ?>
        ...
        <div class="col-md-8 text-right mbot15 show_quantity_as_wrapper">
            <div class="mtop10">
        ...
        <table class="table estimate-items-table items table-main-estimate-edit no-mtop">
            ...
            <?php if (isset($estimate) || isset($add_items) || isset($invoice)) {
                ...
                foreach ($add_items as $item) {
                    ...
                    if (isset($invoice)) {
                        $estimate_item_taxes = get_service_invoice_item_taxes($item['id']);;
                    }
                    if ($item['id'] == 0) {
                        ...
                        <div class="col-md-5">
                            <div class="input-group" id="discount-total">
                                ...
                                <input type="number" data-toggle="tooltip"
                                       ...
                                       class="form-control pull-left input-discount-fixed<?php if (!isset($invoice) || (isset($invoice) && !is_sale_discount($invoice, 'fixed') && !is_sale_discount_applied($invoice))) {
                                           echo ' hide';
                                       } ?>"
