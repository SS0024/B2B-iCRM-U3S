  ...
  <div id="invoice-preview">
   <div class="row">
     ...
     <div class="col-md-12">
      ...
      <?php echo '<p class="text-muted mtop15">'._l('invoice_recurring_from','<a href="'.admin_url('service_invoices/list_invoices/'.$invoice->is_recurring_from).'" onclick="init_invoice('.$invoice->is_recurring_from.');return false;">'.format_service_invoice_number($invoice->is_recurring_from).'</a></p>'); ?>
      <?php } ?>
   </div>
   ...
   <div class="col-md-12">
      ...
      <div class="col-md-6 col-sm-6">
         <h4 class="bold">
            ...
            ?>
            <a href="<?php echo admin_url('service_invoices/invoice/'.$invoice->id); ?>">
               <span id="invoice-number">
                  <?php echo format_service_invoice_number($invoice->id); ?>
               </span>
            </a>
         </h4>
         <address>
      ...
      <div class="col-sm-6 text-right">
         ...
         <p class="no-mbot">
            <span class="bold">
               <?php echo 'Service '._l('invoice_data_date'); ?>
            </span>
         ...
         <?php } ?>
         <?php $pdf_custom_fields = get_custom_fields('service_invoice',array('show_on_pdf'=>1));
         foreach($pdf_custom_fields as $field){
          $value = get_custom_field_value($invoice->id,$field['id'],'service_invoice');
          if($value == ''){continue;} ?>
          <p class="no-mbot">
            ...
            <table class="table items invoice-items-preview">
               <thead>
                  <tr>
                     ...
                     <?php
                     $custom_fields = get_items_custom_fields_for_table_html($invoice->id,'service_invoice');
                   ...
                   <?php } ?>
<!--                     <th align="right">--><?php //echo _l('invoice_table_discount_heading'); ?><!--</th>-->
             ...
             <tbody>
               <?php
               $items_data = get_table_items_and_taxes($invoice->items,'service_invoice',true,0,0);
            ...
            <tr>
              ...
              <!-- <tr>
               ...
               <tr>
                  ...
                  <td>
                     <?php echo '-' . format_money(sum_from_table('tblinvoiceservicepaymentrecords',array('field'=>'amount','where'=>array('invoiceid'=>$invoice->id))),$invoice->symbol); ?>
                  </td>
               </tr>
               <?php } ?>
