...
<div class="panel_s no-padding mbot5">
   <div class="panel-body">
      ...
      <p>
         <a href="<?php echo admin_url('service_invoices/list_invoices/'.$_inv->id); ?>" target="_blank"><?php echo format_service_invoice_number($_inv->id); ?></a> - <?php echo format_money($_inv->total,$_inv->symbol); ?>
...
<?php echo form_hidden('_attachment_sale_type','service_invoice'); ?>
         ...
         <div class="horizontal-scrollable-tabs preview-tabs-top">
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                  ...
                  <?php } ?>
                   <!--<li role="presentation">
                       <a href="#tab_delivery_details" onclick="init_rel_tasks_table(<?php /*echo $invoice->id; */?>,'invoice'); return false;" aria-controls="tab_delivery_details" role="tab" data-toggle="tab">
                           <?php /*echo _l('Delivery Details'); */?>
                       </a>
                   </li>-->
                  <!--<li role="presentation">
            ...
            <div class="col-md-10 _buttons">
               ...
               <div class="pull-right">
                  <?php
                     ...
                     ?>
                  <?php if(has_permission('service_invoices','','edit')){ ?>
                  <a href="<?php echo admin_url('service_invoices/invoice/'.$invoice->id); ?>" data-toggle="tooltip" title="<?php echo _l('edit_invoice_tooltip'); ?>" class="btn btn-default btn-with-tooltip" data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
                  <div class="btn-group">
                     <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-file-pdf-o"></i><?php if(is_mobile()){echo ' PDF';} ?> <span class="caret"></span></a>
                     <ul class="dropdown-menu dropdown-menu-right">
                        <li class="hidden-xs"><a href="<?php echo admin_url('service_invoices/pdf/'.$invoice->id.'?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a></li>
                        <li class="hidden-xs"><a href="<?php echo admin_url('service_invoices/pdf/'.$invoice->id.'?output_type=I'); ?>" target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
                        <li><a href="<?php echo admin_url('service_invoices/pdf/'.$invoice->id); ?>"><?php echo _l('download'); ?></a></li>
                        <li>
                        <li><a href="<?php echo admin_url('service_invoices/pipdf/'.$invoice->id); ?>"><?php echo "Download PI"; ?></a></li>
                        <li>
                           <a href="<?php echo admin_url('service_invoices/pdf/'.$invoice->id.'?print=true'); ?>" target="_blank">
                           <?php echo _l('print'); ?>
                           </a>
                        </li>
                     </ul>
                  ...
                  <!-- Single button -->
				  <!-- Delivery Bill -->
<!--				  <a href="--><?php //echo admin_url('service_invoices/delivery_details/'.$invoice->id); ?><!--" data-toggle="tooltip" title="--><?php //echo _l('delivery_details_tooltip'); ?><!--" class="btn btn-primary btn-with-tooltip" data-placement="bottom"><i class="fa fa-truck"></i></a>-->
				  
				  <!-- Way Bill -->
				  <!--<div class="btn-group">
						<button type="button" class="btn btn-default pull-left dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						 <?php /*echo _l('way_bill'); */?><i class="fa fa-file"></i>  <span class="caret"></span>
						</button>
						<ul class="dropdown-menu dropdown-menu-right">
							<li class="hidden-xs"><a href="<?php /*echo admin_url('service_invoices/pdf/'.$invoice->id.'?output_type=I&type=way_bill'); */?>"><?php /*echo _l('view_pdf'); */?></a></li>
							<li class="hidden-xs"><a href="<?php /*echo admin_url('service_invoices/pdf/'.$invoice->id.'?output_type=I&type=way_bill'); */?>" target="_blank"><?php /*echo _l('view_pdf_in_new_window'); */?></a></li>
							<li><a href="<?php /*echo admin_url('service_invoices/pdf/'.$invoice->id.'?type=way_bill'); */?>"><?php /*echo _l('download'); */?></a></li>
							<li>
							   <a href="<?php /*echo admin_url('service_invoices/pdf/'.$invoice->id.'?print=true&type=way_bill'); */?>" target="_blank">
							   <?php /*echo _l('print'); */?>
							   </a>
							</li>
						</ul>
...
<!--                        <li><a href="--><?php //echo site_url('invoice/' . $invoice->id . '/' .  $invoice->hash) ?><!--" target="_blank">--><?php //echo _l('view_invoice_as_customer_tooltip'); ?><!--</a></li>-->
                        <li>
                           ...
                           <a href="<?php echo admin_url('service_invoices/send_overdue_notice/'.$invoice->id); ?>"><?php echo _l('send_overdue_notice_tooltip'); ?></a>
                           <?php } ?>
                        </li>
                        ...
                        <?php if(has_permission('service_invoices','','create')){ ?>
                        <!--<li>
                           <a href="<?php /*echo admin_url('service_invoices/copy/'.$invoice->id); */?>"><?php /*echo _l('invoice_copy'); */?></a>
                        </li>-->
                        <?php } ?>
                        <?php if($invoice->sent == 0){ ?>
                        <li>
                           <a href="<?php echo admin_url('service_invoices/mark_as_sent/'.$invoice->id); ?>"><?php echo _l('invoice_mark_as_sent'); ?></a>
                        </li>
                        <?php } ?>
                        <?php if(has_permission('service_invoices','','edit') || has_permission('service_invoices','','create')){ ?>
                        <li>
                           <?php if($invoice->status != 5 && $invoice->status != 2 && $invoice->status != 3){ ?>
                           <a href="<?php echo admin_url('service_invoices/mark_as_cancelled/'.$invoice->id); ?>"><?php echo _l('invoice_mark_as',_l('invoice_status_cancelled')); ?></a>
                           <?php } else if($invoice->status == 5) { ?>
                           <a href="<?php echo admin_url('service_invoices/unmark_as_cancelled/'.$invoice->id); ?>"><?php echo _l('invoice_unmark_as',_l('invoice_status_cancelled')); ?></a>
                           <?php } ?>
                        </li>
                        <?php } ?>
                        <?php if(!in_array($invoice->status, array(2,5,6)) && has_permission('service_invoices','','edit') && $invoice->duedate && is_invoices_overdue_reminders_enabled()){ ?>
                        <li>
                           <?php if($invoice->cancel_overdue_reminders == 1) { ?>
                           <a href="<?php echo admin_url('service_invoices/resume_overdue_reminders/'.$invoice->id); ?>"><?php echo _l('resume_overdue_reminders'); ?></a>
                           <?php } else { ?>
                           <a href="<?php echo admin_url('service_invoices/pause_overdue_reminders/'.$invoice->id); ?>"><?php echo _l('pause_overdue_reminders'); ?></a>
                           <?php } ?>
                        </li>
                        <?php } ?>
                        <?php
                           if((get_option('delete_only_on_last_invoice') == 1 && is_last_invoice($invoice->id)) || (get_option('delete_only_on_last_invoice') == 0)){ ?>
                        <?php if(has_permission('service_invoices','','delete')){ ?>
                        <li data-toggle="tooltip" data-title="<?php echo _l('delete_invoice_tooltip'); ?>">
                           <a href="<?php echo admin_url('service_invoices/delete/'.$invoice->id); ?>" class="text-danger delete-text _delete"><?php echo _l('delete_invoice'); ?></a>
                        </li>
                        <?php } ?>
                        <?php } ?>
                     </ul>
                  ...
                  <a href="#" onclick="record_service_payment(<?php echo $invoice->id; ?>); return false;"  class="mleft10 pull-right btn btn-success<?php if($invoice->status == 2 || $invoice->status == 5){echo ' disabled';} ?>">
         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab_invoice">
               ...
               <?php } ?>
               <?php $this->load->view('admin/service_invoices/invoice_preview_html'); ?>
            </div>
            <?php if(count($invoice->payments) > 0) { ?>
            <div class="tab-pane" role="tabpanel" id="invoice_payments_received">
               <?php include_once(APPPATH . 'views/admin/service_invoices/invoice_payments_table.php'); ?>
            </div>
            <?php } ?>
            <?php if(count($applied_credits) > 0){ ?>
...
/*                                    $i = 1;
                                    foreach($invoices_delivery_modules as $invoices_delivery_module) {  */?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php /*echo admin_url('/service_invoices/list_invoices/'.$invoices_delivery_module['invoice_id']);*/?>" target="_blank"><?php /*echo $invoices_delivery_module['sale_reference_no']; */?></a>
                                            </td>
...
/*                }
            ...
            <div role="tabpanel" class="tab-pane" id="tab_tasks">
               <?php init_relation_tasks_table(array('data-new-rel-id'=>$invoice->id,'data-new-rel-type'=>'service_invoice')); ?>
            </div>
            <div role="tabpanel" class="tab-pane" id="tab_reminders">
               ...
               <?php $this->load->view('admin/includes/modals/reminder',array('id'=>$invoice->id,'name'=>'service_invoice','members'=>$members,'reminder_title'=>_l('invoice_set_reminder_title'))); ?>
            </div>
            <?php if($invoice->recurring > 0){ ?>
            <div role="tabpanel" class="tab-pane" id="tab_child_invoices">
               ...
               <ul class="list-group">
                  ...
                  <li class="list-group-item">
                     <a href="<?php echo admin_url('service_invoices/list_invoices/'.$recurring->id); ?>" onclick="init_invoice(<?php echo $recurring->id; ?>); return false;" target="_blank"><?php echo format_service_invoice_number($recurring->id); ?>
            ...
            <div role="tabpanel" class="tab-pane" id="tab_emails_tracking">
               <?php
                  $this->load->view('admin/includes/emails_tracking',array(
                     'tracked_emails'=>
                     get_tracked_emails($invoice->id, 'service_invoice'))
                  );
                  ?>
            </div>
            <div role="tabpanel" class="tab-pane" id="tab_notes">
               <?php echo form_open(admin_url('service_invoices/add_note/'.$invoice->id),array('id'=>'sales-notes','class'=>'invoice-notes-form')); ?>
            ...
            <div role="tabpanel" class="tab-pane" id="tab_views">
               <?php
                  $views_activity = get_views_tracking('service_invoice',$invoice->id);
...
<?php $this->load->view('admin/service_invoices/invoice_send_to_client'); ?>
<?php $this->load->view('admin/credit_notes/apply_service_invoice_credits'); ?>
<?php $this->load->view('admin/credit_notes/service_invoice_create_credit_note_confirm'); ?>
<script>
