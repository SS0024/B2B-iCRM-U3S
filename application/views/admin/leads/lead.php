  ...
  <div class="row">
   ...
   <div class="top-lead-menu">
      ...
      <ul class="nav-tabs-horizontal nav nav-tabs<?php if(!isset($lead)){echo ' lead-new';} ?>" role="tablist">
         ...
         <?php } ?>
         <li role="presentation">
            <a href="#tab_proposals_leads" onclick="initDataTable('.table-proposals-lead', admin_url + 'inquiries/proposal_relations/' + <?php echo $lead->id; ?> + '/lead','undefined', 'undefined','undefined',[6,'desc']);" aria-controls="tab_proposals_leads" role="tab" data-toggle="tab">
            <?php echo _l('Inquiries'); ?>
            </a>
         </li>
         <li role="presentation">
   ...
   <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane" id="tab_proposals_leads">
         ...
         <a href="<?php echo admin_url('inquiries/inquiry?rel_type=lead&rel_id='.$lead->id); ?>" class="btn btn-info mbot25"><?php echo _l('new_inquiry'); ?></a>
         <?php } ?>
         <?php if(total_rows('tblinquiries',array('rel_type'=>'lead','rel_id'=>$lead->id))> 0 && (has_permission('proposals','','create') || has_permission('proposals','','edit'))){ ?>
         <a href="#" class="btn btn-info mbot25" data-toggle="modal" data-target="#sync_data_proposal_data"><?php echo _l('sync_data'); ?></a>
         <?php $this->load->view('admin/inquiries/sync_data',array('related'=>$lead,'rel_id'=>$lead->id,'rel_type'=>'lead')); ?>
         <?php } ?>
         <?php
            $table_data = array(
             _l('inquiry') . ' #',
