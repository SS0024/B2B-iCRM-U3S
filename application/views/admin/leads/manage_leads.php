                     ...
                     <div class="row" id="leads-table">
                        ...
                        <div class="col-md-12">
                           ...
                           <?php
							  ...
							  /*$_table_data[] = array(                               'name'=>_l('leads_dt_attachment'),                               'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-attachment')                              );
                              $_table_data[] =  array(
                               'name'=>_l('tags'),
                              ...
                              $_table_data[] = array(
                               'name'=>_l('Reminder Date'),
                               'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-reminder-date')
                              );
                              $_table_data[] = array(
