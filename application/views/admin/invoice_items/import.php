      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-4">
                <?php echo form_open_multipart($this->uri->uri_string(),array('id'=>'import_new_form')) ;?>
                <?php echo form_hidden('new_items_import','true'); ?>
                <?php echo render_input('new_file_csv','choose_csv_file','','file'); ?>
                <div class="form-group">
                  <button type="button" class="btn btn-info import btn-new-import-submit"><?php echo _l('import'); ?></button>
                </div>
                <?php echo form_close(); ?>
              </div>
            </div>
...
<script>
  ...
  $(function(){
   _validate_form($('#import_new_form'),{new_file_csv:{required:true,extension: "csv"}});
      $('.btn-new-import-submit').on('click',function(){
      $('#import_new_form').submit();
      });
 });
</script>
</body>
