            ...
            <div class="panel_s">
                <div class="panel-body">
                    ...
                    <div class="row home-summary">
                            ...
                            <div class="col-md-12 col-sm-6 col-lg-4">
                                <div class="row">
                                    <div class="col-md-12 text-stats-wrapper">
                                        <p class="text-dark text-uppercase"><?php echo _l('Inquiry overview'); ?></p>
                                        <hr class="mtop15"/>
                                    </div>
                                    <?php foreach ($proposal_statuses as $status) {
                                        $url = admin_url('inquiries/list_inquiries?status=' . $status);
                                        $percent_data = get_inquiries_percent_by_status($status);
                                        ?>
                                        <div class="col-md-12 text-stats-wrapper">
                                            <a href="<?php echo $url; ?>"
                        ...
                        <?php } ?>
                        <?php if (has_permission('purchaseorder', '', 'view') || has_permission('purchaseorder', '', 'view_own')) { ?>
                            <div class="col-md-6 col-lg-4 col-sm-6">
                                <div class="row">
                                    <div class="col-md-12 text-stats-wrapper">
                                        <p class="text-dark text-uppercase"><?php echo _l('PO OVERVIEW'); ?></p>
                                        <hr class="mtop15"/>
                                    </div>
                                    <?php
                                    // Add not sent
                                    array_splice($purchaseorder_statuses, 1, 0);
                                    foreach ($purchaseorder_statuses as $status) {
                                        $url = admin_url('purchaseorder/list_purchaseorder?status=' . $status);
                                        /*if (!is_numeric($status)) {
                                            $url = admin_url('purchaseorder/list_purchaseorder?filter=' . $status);
                                        }*/
                                        $percent_data = get_purchaseorder_percent_by_status($status);
                                        ?>
                                        <div class="col-md-12 text-stats-wrapper">
                                            <a href="<?php echo $url; ?>"
                                               class="text-<?php echo estimate_status_color_class($status, true); ?> mbot15 inline-block estimate-status-dashboard-<?php echo estimate_status_color_class($status, true); ?>">
                            ...
                            <div class="clearfix"></div>
                        <?php } ?>
                        <?php if (has_permission('requisite_forms', '', 'view') || has_permission('requisite_forms', '', 'view_own')) { ?>
                            <div class="col-md-6 col-lg-4 col-sm-6">
                                <div class="row">
                                    <div class="col-md-12 text-stats-wrapper">
                                        <p class="text-dark text-uppercase"><?php echo _l('Requisite Form OVERVIEW'); ?></p>
                                        <hr class="mtop15"/>
                                    </div>
                                    <?php
                                    // Add not sent
                                    array_splice($estimate_statuses, 1, 0);
                                    foreach ($estimate_statuses as $status) {
                                        $url = admin_url('requsite_forms/list_requsite_forms?status=' . $status);
                                        /*if (!is_numeric($status)) {
                                            $url = admin_url('purchaseorder/list_purchaseorder?filter=' . $status);
                                        }*/
                                        $percent_data = get_requisite_forms_percent_by_status($status);
                                        ?>
                                        <div class="col-md-12 text-stats-wrapper">
                                            <a href="<?php echo $url; ?>"
                                               class="text-<?php echo estimate_status_color_class($status, true); ?> mbot15 inline-block estimate-status-dashboard-<?php echo estimate_status_color_class($status, true); ?>">
