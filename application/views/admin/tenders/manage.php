         ...
         <div class="col-md-12">
            <div class="panel_s mbot10">
               <div class="panel-body _buttons">
                  <?php if(has_permission('tenders','','create')){ ?>
                  <a href="<?php echo admin_url('tenders/tender'); ?>" class="btn btn-info pull-left display-block">
                  <?php echo _l('new_tender'); ?>
                  </a>
                  <?php } ?>
                        ...
                        <?php
                           $table_data = array(
                             ...
                             render_datatable($table_data,'inquiries',[],[
                                 'data-last-order-identifier' => 'inquiries',
                                 'data-default-order'         => get_table_last_order('inquiries'),
                             ]);
                           ?>
                     </div>
                  </div>
...
<script>
   ...
   $(function(){
     ...
     initDataTable('.table-inquiries', admin_url+'tenders/table', ['undefined'], ['undefined'], Proposals_ServerParams, [7, 'desc']);
