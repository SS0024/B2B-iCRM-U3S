...
<?php echo form_hidden('_attachment_sale_type', 'tender'); ?>
<div class="panel_s">
    <div class="panel-body">
                ...
                <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                    ...
                    <?php if (isset($proposal)) { ?>
                        <!--<li role="presentation">
                            <a href="#tab_comments" onclick="get_tender_comments(); return false;"
                        ...
                        <li role="presentation">
                            <a href="#tab_reminders"
                               onclick="initDataTable('.table-reminders', admin_url + 'misc/get_reminders/' + <?php echo $proposal->id; ?> + '/' + 'tender', undefined, undefined, undefined,[1,'asc']); return false;"
                        ...
                        <!--<li role="presentation" class="tab-separator">
                            <a href="#tab_tasks"
                               onclick="init_rel_tasks_table(<?php /*echo $proposal->id; */ ?>,'tender'); return false;"
                        ...
                        <li role="presentation" class="tab-separator">
                            <a href="#tab_notes"
                               onclick="get_sales_notes(<?php echo $proposal->id; ?>,'tenders'); return false"
        ...
        <div class="row">
            ...
            <div class="col-md-9 text-right _buttons proposal_buttons">
                <?php if (has_permission('tenders', '', 'edit')) { ?>
                    <a href="<?php echo admin_url('tenders/tender/' . $proposal->id); ?>" data-placement="left"
                ...
                <!--<div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li class="hidden-xs"><a
                                    href="<?php /*echo admin_url('tenders/pdf/' . $proposal->id . '?output_type=I'); */ ?>"><?php /*echo _l('view_pdf'); */ ?></a>
                        </li>
                        <li class="hidden-xs"><a
                                    href="<?php /*echo admin_url('tenders/pdf/' . $proposal->id . '?output_type=I'); */ ?>"
                                    target="_blank"><?php /*echo _l('view_pdf_in_new_window'); */ ?></a></li>
                        <li>
                            <a href="<?php /*echo admin_url('tenders/pdf/' . $proposal->id); */ ?>"><?php /*echo _l('download'); */ ?></a>
                        </li>
                        <li>
                            <a href="<?php /*echo admin_url('tenders/pdf/' . $proposal->id . '?print=true'); */ ?>"
                               target="_blank">
                                <?php /*echo _l('print'); */ ?>
                            </a>
                        </li>
                ...
                <div class="btn-group ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <?php if (!empty($proposal->open_till) && date('Y-m-d') < $proposal->open_till && ($proposal->status == 4 || $proposal->status == 1) && is_proposals_expiry_reminders_enabled()) { ?>
                            <li>
                                <a href="<?php echo admin_url('tenders/send_expiry_reminder/' . $proposal->id); ?>"><?php echo _l('send_expiry_reminder'); ?></a>
                            </li>
                        <?php } ?>
                        <li>
                        ...
                        <?php /*if (has_permission('proposals', '', 'create')) { */?><!--
                            <li>
                                <a href="<?php /*echo admin_url() . 'tenders/copy/' . $proposal->id; */?>"><?php /*echo _l('proposal_copy'); */?></a>
                            </li>
                        --><?php /*} */?>
                            ...
                            <?php foreach ($proposal_statuses as $status) {
                                if (has_permission('tenders', '', 'edit')) {
                                    if ($proposal->status != $status) { ?>
                                        <li>
                                            <a href="<?php echo admin_url() . 'tenders/mark_action_status/' . $status . '/' . $proposal->id; ?>"><?php echo _l('proposal_mark_as', format_proposal_status($status, '', false)); ?></a>
                                        </li>
                                        <?php
                                    }
                                }
                        ...
                        <?php } ?>
                        <?php if (!empty($proposal->signature) && has_permission('tenders', '', 'delete')) { ?>
                            <li>
                                <a href="<?php echo admin_url('tenders/clear_signature/' . $proposal->id); ?>"
                                   class="_delete">
                                    <?php echo _l('clear_signature'); ?>
                                </a>
                            </li>
                        <?php } ?>
                        <?php if (has_permission('tenders', '', 'delete')) { ?>
                            <li>
                                <a href="<?php echo admin_url() . 'tenders/delete/' . $proposal->id; ?>"
                        ...
                        <div class="row mtop10">
                                ...
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        <?php echo _l('accepted_identity_info', array(
                                            ...
                                            '<b>' . $proposal->acceptance_ip . '</b>' . (is_admin() ? '&nbsp;<a href="' . admin_url('tenders/clear_acceptance_info/' . $proposal->id) . '" class="_delete text-muted" data-toggle="tooltip" data-title="' . _l('clear_this_information') . '"><i class="fa fa-remove"></i></a>' : '')
                                        )); ?>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="col-md-6">
                                <h4 class="bold">
                                    ...
                                    ?>
                                    <a href="<?php echo admin_url('tenders/tender/' . $proposal->id); ?>">
                                       <span id="proposal-number">
                                       <?php echo $proposal->tender_number; ?> (<?php echo $proposal->tender_title; ?>)
                                       </span>
                                    </a>
                                </h4>
                                <h5 class="bold mbot15 font-medium"><a
                                            href="<?php echo admin_url('tenders/tender/' . $proposal->id); ?>"><?php echo $proposal->subject; ?></a>
                                </h5>
                                <address>
                                    <?php echo format_organization_info(); ?>
                                </address>
                                <p><b>Admin notes:</b><br><?= $proposal->adminnote ?></p>
                                <span><b>Modified:</b> <?= _dt($proposal->modifieddate) ?></span>
                            </div>
                            <div class="col-md-6 text-right">
                                ...
                                <?php if (!empty($proposal->open_till)) { ?>
                                    <p class="no-mbot">
                                        <span class="bold"><?php echo _l('Tender Due Date'); ?>:</span>
                                ...
                                <?php } ?>
                                <?php if (!empty($proposal->tender_fees)) { ?>
                                    <p class="no-mbot">
                                        <span class="bold"><?php echo _l('Tender Fees'); ?>:</span>
                                        <?php echo format_money($proposal->tender_fees,$this->currencies_model->get($proposal->currency)->symbol); ?>
                                    </p>
                                <?php } ?>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table items invoice-items-preview">
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                            $custom_fields = get_items_custom_fields_for_table_html($proposal->id, 'tender');
                                        ...
                                        <tbody>
                                        <?php
                                        $items_data = get_table_items_and_taxes($proposal->items, 'tender', true);
                  ...
                  <span class="bold"><?php echo _l('invoice_discount'); ?>
                      ...
                      <?php } ?></span>
                        ...
                        if (count($proposal->attachments) > 0) { ?>
                            <p class="bold"><?php echo _l('Tender Files'); ?></p>
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <?php if ($attachment['staffid'] == get_staff_user_id() || is_admin()) { ?>
                                            <a href="#" class="text-danger"
                                               onclick="delete_tender_attachment(<?php echo $attachment['id']; ?>); return false;"><i
                        ...
                        <div class="row proposal-comments mtop15">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-info mtop10 pull-right"
                                        onclick="add_tender_comment();"><?php /*echo _l('proposal_add_comment'); */ ?></button>
                            </div>
                        </div>
                    </div>-->
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_notes">
                        <?php echo form_open(admin_url('tenders/add_note/' . $proposal->id), array('id' => 'sales-notes', 'class' => 'proposal-notes-form')); ?>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_emails_tracking">
                        ...
                        $this->load->view('admin/includes/emails_tracking', array(
                                'tracked_emails' =>
                                    get_tracked_emails($proposal->id, 'tender'))
                        );
                        ?>
                    </div>
                    <!--<div role="tabpanel" class="tab-pane" id="tab_tasks">
                        <?php /*init_relation_tasks_table(array('data-new-rel-id' => $proposal->id, 'data-new-rel-type' => 'tender')); */ ?>
                    </div>-->
                    <div role="tabpanel" class="tab-pane" id="tab_reminders">
                        <a href="#" data-toggle="modal" class="btn btn-info"
                           data-target=".reminder-modal-tender-<?php echo $proposal->id; ?>"><i
                                    class="fa fa-bell-o"></i> <?php echo _l('Set tender reminder'); ?></a>
                        <hr/>
                        <?php render_datatable(array(_l('reminder_description'), _l('reminder_date'), _l('reminder_staff'), _l('reminder_is_notified')), 'reminders'); ?>
                        <?php $this->load->view('admin/includes/modals/reminder', array('id' => $proposal->id, 'name' => 'tender', 'members' => $members, 'reminder_title' => _l('Set tender reminder'))); ?>
                    </div>
                    <div role="tabpanel" class="tab-pane ptop10" id="tab_views">
                        <?php
                        $views_activity = get_views_tracking('tender', $proposal->id);
...
<?php $this->load->view('admin/tenders/send_proposal_to_email_template'); ?>
<script>
