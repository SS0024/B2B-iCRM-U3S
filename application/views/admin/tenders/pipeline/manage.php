                    ...
                    <div class="panel-body _buttons">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <a href="<?php echo admin_url('tenders/proposal'); ?>" class="btn btn-info pull-left new"><?php echo _l('new_proposal'); ?></a>
                                <?php } ?>
                                <a href="<?php echo admin_url('tenders/pipeline/'.$switch_pipeline); ?>" class="btn btn-default mleft5 pull-left"><?php echo _l('switch_to_list_view'); ?></a>
                            </div>
