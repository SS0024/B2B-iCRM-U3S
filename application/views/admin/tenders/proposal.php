                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 border-right">
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php $value = (isset($proposal) ? $proposal->tender_number : ''); ?>
                                        <?php echo render_input('tender_number', 'Tender Number', $value); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php $value = (isset($proposal) ? $proposal->tender_title : ''); ?>
                                        <?php echo render_input('tender_title', ' Tender Title', $value); ?>
                                    </div>
                                </div>
                        ...
                        --><?php /*echo render_input('subject','proposal_subject',$value,'text',$attrs); */ ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php echo render_date_input('date', 'Tender Date', $value); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php
                                        $value = '';
                                        ...
                                        echo render_date_input('open_till', 'Tender Due Date', $value); ?>
                                    </div>
                                </div>
                                <?php
                                $selected = '';
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <?php
                                        $value = (isset($proposal) ? $proposal->tender_fees : 0);
                                        echo render_input('tender_fees', "Tender Fees", $value,'number');
                                        ?>
                                    </div>
                                    <div class="col-md-4">
                                        <?php
                                        $value = (isset($proposal) ? $proposal->tender_emd : 0);
                                        echo render_input('tender_emd', "Tender EMD", $value,'number');
                                        ?>
                                    </div>
                                    <?php
                                        if (!isset($proposal)){
                                            ?>
                                            <div class="col-md-4">
                                                <?php echo render_date_input('reminder_date', 'EMD Reminder'); ?>
                                            </div>
                                            <?php
                                        }
                                    ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row" >
                                    <div class="table-responsive s_table">
                                        <table class="table master_file">
                                            <thead class="grey lighten-2">
                                            <tr>
                                                <th align="center">Master Files</th>
                                                <th width="10%" align="center"><i class="fa fa-cog"></i></th>
                                            </tr>
                                            </thead>
                                            <tbody class="ui-sortable">
                                            <tr class="main">
                                                <td class="master-file-td">
                                                    <?= render_input('master_file','','','url'); ?>
                                                </td>
                                                <td class="action-td">
                                                    <button type="button"
                                                            onclick="add_master_file_to_table(this); return false;"
                                                            class="btn pull-right btn-info"><i class="fa fa-check"></i></button>
                                                </td>
                                            </tr>
                                            <?php
                                            if(isset($proposal->id)){
                                                $divConArray = explode(', ',$proposal->master_files);
                                                foreach ($divConArray as $con_div)
                                                {
                                                    ?>
                                                    <tr>
                                                        <td><input type="hidden" name="master_files[]" value="<?= $con_div; ?>"><a href="<?= $con_div; ?>" target="_blank"><?= $con_div; ?></a></td>
                                                        <td><button type="button" onclick="remove_master_file_to_table(this); return false;" class="btn pull-right btn-danger "><i class="fa fa-trash"></i></button></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
...
<script>
    ...
    function add_master_file_to_table(a) {
        let mainHtmlBlock = $(a).parent().parent();
        let masterFile = mainHtmlBlock.find('#master_file').val();
        if(masterFile != '' && masterFile != null && is_url(masterFile)){
            let htmlBlock = '<tr>' +
                '<td><input type="hidden" name="master_files[]" value="'+masterFile+'"><a href="' + masterFile + '" target="_blank">' + masterFile + '</a></td>' +
                '<td><button type="button" onclick="remove_master_file_to_table(this); return false;" class="btn pull-right btn-danger "><i class="fa fa-trash"></i></button></td>' +
                '</tr>';
            $('table.master_file tbody').append(htmlBlock);
            mainHtmlBlock.find('#master_file').val('');
        }
    }
    ...
    function remove_master_file_to_table(a) {
        $(a).parent().parent().remove();
    }
    $(function () {
        ...
        $('body').on('change', '#rel_id', function () {
            ...
            if ($(this).val() != '') {
                $.get(admin_url + 'tenders/get_relation_data_values/' + $(this).val() + '/' + _rel_type.val(), function (response) {
        ...
        $('input[name="state"]').on("blur", function () {
            ...
            if (state != '') {
                $.get(admin_url + 'tenders/get_gst_devision/' + state, function (response) {
