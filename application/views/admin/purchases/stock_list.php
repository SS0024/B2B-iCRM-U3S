                        ...
                        <div class="_buttons">
                            <div class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="Filter by">
                                ...
                                <ul class="dropdown-menu dropdown-menu-left" style="width:300px;">
                                    ...
                                    <li class="divider"></li>
                                    <li  class="active">
                                        <a href="#" data-cview="1" onclick="dt_custom_view('1','.table-warehouses','in_stock'); return false;">
                                            Stock in remain</a>
                                    </li>
                                    <li>
                                        <a href="#" data-cview="2" onclick="dt_custom_view('2','.table-warehouses','in_stock'); return false;">
                                            Stock in done</a>
                                    </li>
                                </ul>
                            </div>
