   ...
   <div class="panel_s mbot10">
      <div class="panel-body _buttons erer">
         ...
         <?php if(has_permission('purchases','','create')){ ?>
            <a href="<?php echo admin_url('purchases/purchase'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('Add new indent'); ?></a>
         <?php } ?>
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/purchases/table_html'); ?>
            </div>
         </div>
      </div>
