                    ...
                    <div class="pull-right _buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li>
                                <li>
                                    <a href="<?php echo admin_url('estimates/pipdf/' . $estimate->id); ?>"><?php echo "Download PI"; ?></a>
                                </li>
                                <li>
                        ...
                        <?php
                            ...
                            ?>
                            <?php if (has_permission('purchaseorder', '', 'create') && !empty($estimate->clientid) && $showBtn) { ?>
                                <div class="btn-group pull-right mleft5">
                                    ...
                                    <ul class="dropdown-menu">
                                        <!--<li><a href="<?php /*echo admin_url('estimates/convert_to_invoice/'.$estimate->id.'?save_as_draft=true'); */ ?>"><?php /*echo _l('convert_and_save_as_draft').' Invoice'; */ ?></a></li>
                        <li><a href="<?php /*echo admin_url('estimates/convert_to_invoice/'.$estimate->id); */ ?>"><?php /*echo _l('convert').' Invoice'; */ ?></a></li>
                         <li class="divider"></li>-->
                                        <li>
                    ...
                    <div id="estimate-preview">
                        <div class="row">
                           ...
                           <?php echo format_estimate_number($estimate->id); ?>
                                ...
                                <?php
                                if (!empty($estimate->purchaseorders)) {
                                    echo '<p>';
                                    foreach ($estimate->purchaseorders as $purchaseorder) {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    ...
                                    $items_data = get_table_items_and_taxes($estimate->items, 'estimate', true,0,$isDiscountDisplay);
                                    /* echo '<pre>';
                                        print_r($estimate);
                                    echo '</pre>'; */
                                    ?>
