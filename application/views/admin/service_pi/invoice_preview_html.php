  ...
  <div id="invoice-preview">
   <div class="row">
     ...
     <div class="col-md-12">
      ...
      <?php echo '<p class="text-muted mtop15">'._l('invoice_recurring_from','<a href="'.admin_url('service_pi/list_invoices/'.$invoice->is_recurring_from).'" onclick="init_invoice('.$invoice->is_recurring_from.');return false;">'.format_service_pi_number($invoice->is_recurring_from).'</a></p>'); ?>
      <?php } ?>
   </div>
   ...
   <div class="col-md-12">
      ...
      <div class="col-md-6 col-sm-6">
         <h4 class="bold">
            ...
            ?>
            <a href="<?php echo admin_url('service_pi/invoice/'.$invoice->id); ?>">
               <span id="invoice-number">
                  <?php echo format_service_pi_number($invoice->id); ?>
               </span>
            </a>
         </h4>
         <address>
            ...
            <table class="table items invoice-items-preview">
               <thead>
                  <tr>
                     ...
                     <?php
                     $custom_fields = get_items_custom_fields_for_table_html($invoice->id,'service_pi');
...
<!--                     <th align="right">--><?php //echo _l('invoice_table_discount_heading'); ?><!--</th>-->
             ...
             <tbody>
               <?php
               $items_data = get_table_items_and_taxes($invoice->items,'service_pi',true,0,0);
