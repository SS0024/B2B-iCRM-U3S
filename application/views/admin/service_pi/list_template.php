<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons erer">
         <?php $this->load->view('admin/service_pi/invoices_top_stats'); ?>
         <?php if(has_permission('service_pi','','create')){ ?>
            <a href="<?php echo admin_url('service_pi/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('Create new service pi'); ?></a>
         <?php } ?>
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/service_pi/table_html'); ?>
            </div>
         </div>
      </div>
