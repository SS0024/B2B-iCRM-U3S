        ...
        <table class="table estimate-items-table items table-main-estimate-edit no-mtop">
            ...
            <?php if (isset($estimate) || isset($add_items) || isset($invoice)) {
                ...
                foreach ($add_items as $item) {
                    ...
                    if (isset($invoice)) {
                        $estimate_item_taxes = get_service_pi_item_taxes($item['id']);;
                    }
                    if ($item['id'] == 0) {
                    ...
                    $table_row .= '<td class="taxrate">' . $this->misc_model->get_taxes_dropdown_template('' . $items_indicator . '[' . $i . '][taxname][]', $estimate_item_taxes, 'service_pi', $item['id'], true, $manual) . '</td>';
