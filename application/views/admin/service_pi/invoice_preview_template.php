...
/*                        $total_reminders = total_rows('tblreminders',
            ...
            <div class="col-md-10 _buttons">
               ...
               <div class="pull-right">
                  <?php
                     ...
                     ?>
                  <?php if(has_permission('service_pi','','edit')){ ?>
                  <a href="<?php echo admin_url('service_pi/invoice/'.$invoice->id); ?>" data-toggle="tooltip" title="<?php echo _l('edit_invoice_tooltip'); ?>" class="btn btn-default btn-with-tooltip" data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
                  <div class="btn-group">
                     <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-file-pdf-o"></i><?php if(is_mobile()){echo ' PDF';} ?> <span class="caret"></span></a>
                     <ul class="dropdown-menu dropdown-menu-right">
                        <li class="hidden-xs"><a href="<?php echo admin_url('service_pi/pdf/'.$invoice->id.'?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a></li>
                        <li class="hidden-xs"><a href="<?php echo admin_url('service_pi/pdf/'.$invoice->id.'?output_type=I'); ?>" target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
                        <li><a href="<?php echo admin_url('service_pi/pdf/'.$invoice->id); ?>"><?php echo _l('download'); ?></a></li>
                        <li>
                        <li><a href="<?php echo admin_url('service_pi/pipdf/'.$invoice->id); ?>"><?php echo "Download PI"; ?></a></li>
                        <li>
                           <a href="<?php echo admin_url('service_pi/pdf/'.$invoice->id.'?print=true'); ?>" target="_blank">
                           <?php echo _l('print'); ?>
                           </a>
                        </li>
                     </ul>
                  ...
                  <div class="btn-group">
                     ...
                     <ul class="dropdown-menu dropdown-menu-right">
                        <!--<li><a href="<?php /*echo site_url('service_pi/' . $invoice->id . '/' .  $invoice->hash) */?>" target="_blank"><?php /*echo _l('view_invoice_as_customer_tooltip'); */?></a></li>
                        <li>
                           ...
                           <a href="<?php /*echo admin_url('service_pi/send_overdue_notice/'.$invoice->id); */?>"><?php /*echo _l('send_overdue_notice_tooltip'); */?></a>
                           <?php /*} */?>
                        </li>
                        ...
                        <li>
                           <a href="<?php /*echo admin_url('service_pi/copy/'.$invoice->id); */?>"><?php /*echo _l('invoice_copy'); */?></a>
                        </li>
                        <?php /*} */?>
                        <?php /*if($invoice->sent == 0){ */?>
                        <li>
                           <a href="<?php /*echo admin_url('service_pi/mark_as_sent/'.$invoice->id); */?>"><?php /*echo _l('invoice_mark_as_sent'); */?></a>
                        </li>-->
                        <?php /*} */?>
                        <?php if(has_permission('service_pi','','edit') || has_permission('service_pi','','create')){ ?>
                        <li>
                           <?php if($invoice->status != 5 && $invoice->status != 2 && $invoice->status != 3){ ?>
                           <a href="<?php echo admin_url('service_pi/mark_as_cancelled/'.$invoice->id); ?>"><?php echo _l('invoice_mark_as',_l('invoice_status_cancelled')); ?></a>
                           <?php } else if($invoice->status == 5) { ?>
                           <a href="<?php echo admin_url('service_pi/unmark_as_cancelled/'.$invoice->id); ?>"><?php echo _l('invoice_unmark_as',_l('invoice_status_cancelled')); ?></a>
                           <?php } ?>
                        </li>
                        <?php } ?>
                        ...
                        <!--<li>
                           ...
                           <a href="<?php /*echo admin_url('service_pi/resume_overdue_reminders/'.$invoice->id); */?>"><?php /*echo _l('resume_overdue_reminders'); */?></a>
                           <?php /*} else { */?>
                           <a href="<?php /*echo admin_url('service_pi/pause_overdue_reminders/'.$invoice->id); */?>"><?php /*echo _l('pause_overdue_reminders'); */?></a>
                           <?php /*} */?>
                        </li>
                        --><?php /*} */?>
                        <?php if(has_permission('service_pi','','delete')){ ?>
                        <li data-toggle="tooltip" data-title="<?php echo _l('delete_invoice_tooltip'); ?>">
                           <a href="<?php echo admin_url('service_pi/delete/'.$invoice->id); ?>" class="text-danger delete-text _delete"><?php echo _l('Delete Service PI'); ?></a>
                        </li>
                        <?php } ?>
                     </ul>
                  </div>
                   ...
                   <div class="btn-group pull-right mleft5">
                       ...
                       <ul class="dropdown-menu"
                           <li>
                               <a href="<?php echo admin_url('service_pi/convert_to_invoice/' . $invoice->id); ?>"><?php echo _l('convert')." to service invoice"; ?></a>
                           </li>
                       </ul>
                   </div>
                   <?php } ?>
         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab_invoice">
               ...
               <?php } ?>
               <?php $this->load->view('admin/service_pi/invoice_preview_html'); ?>
            </div>
            <?php if(count($invoice->payments) > 0) { ?>
            <div class="tab-pane" role="tabpanel" id="invoice_payments_received">
               <?php include_once(APPPATH . 'views/admin/service_pi/invoice_payments_table.php'); ?>
            </div>
            <?php } ?>
...
/*                }
            ...
            <div role="tabpanel" class="tab-pane" id="tab_child_invoices">
               ...
               <ul class="list-group">
                  ...
                  <li class="list-group-item">
                     <a href="<?php echo admin_url('service_pi/list_invoices/'.$recurring->id); ?>" onclick="init_invoice(<?php echo $recurring->id; ?>); return false;" target="_blank"><?php echo format_service_invoice_number($recurring->id); ?>
            ...
            <div role="tabpanel" class="tab-pane" id="tab_notes">
               <?php echo form_open(admin_url('service_pi/add_note/'.$invoice->id),array('id'=>'sales-notes','class'=>'invoice-notes-form')); ?>
...
<?php $this->load->view('admin/service_pi/invoice_send_to_client'); ?>
<script>
