                      ...
                      <div class="row">
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  <label for="customers"><?php echo _l('Customers'); ?></label>
                                  <select name="customers[]" id="customers" onchange="" class="selectpicker" multiple data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('Customers'); ?>">
