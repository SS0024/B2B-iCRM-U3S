                ...
                <div class="panel_s no-margin">
                    <div class="panel-body _buttons">
                       <?php if(has_permission('requisite_forms','','create')){
                        $this->load->view('admin/requsite_forms/estimates_top_stats');
                    } ?>
                    <div class="row">
                        <div class="col-md-8">
                            <?php if(has_permission('requisite_forms','','create')){ ?>
                            <a href="<?php echo admin_url('requsite_forms/requsite_form'); ?>" class="btn btn-info pull-left new"><?php echo _l('create_new_estimate'); ?></a>
                            ...
                            <?php } ?>
                            <a href="<?php echo admin_url('requsite_forms/pipeline/'.$switch_pipeline); ?>" class="btn btn-default mleft5 pull-left"><?php echo _l('switch_to_list_view'); ?></a>
                        </div>
