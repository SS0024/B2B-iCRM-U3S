         <div class="col-md-12">
          <div class="panel_s mbot10">
           <div class="panel-body _buttons">
            <?php $this->load->view('admin/requsite_forms/estimates_top_stats');
           ?>
           <?php if(has_permission('requisite_forms','','create')){ ?>
           <a href="<?php echo admin_url('requsite_forms/requsite_form'); ?>" class="btn btn-info pull-left new new-estimate-btn"><?php echo _l('Create New Requsite Form'); ?></a>
           <?php } ?>
<!--           <a href="--><?php //echo admin_url('requsite_forms/pipeline/'.$switch_pipeline); ?><!--" class="btn btn-default mleft5 pull-left switch-pipeline hidden-xs">--><?php //echo _l('switch_to_pipeline'); ?><!--</a>-->
           <div class="display-block text-right">
             ...
             <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
              ...
              foreach($estimate_statuses as $key=>$status){
                  ?>
              <li class="<?php if($this->input->get('status') == $key){echo 'active';} ?>">
                <a href="#" data-cview="estimates_<?php echo $key; ?>" onclick="dt_custom_view('estimates_<?php echo $key; ?>','.table-requsite_forms','estimates_<?php echo $key; ?>'); return false;">
                  <?php echo $status; ?>
                </a>
              </li>
              <?php } ?>
              ...
              <li class="dropdown-submenu pull-left">
                ...
                <ul class="dropdown-menu dropdown-menu-left">
                 ...
                 <li>
                  <a href="#" data-cview="sale_agent_<?php echo $agent['sale_agent']; ?>" onclick="dt_custom_view(<?php echo $agent['sale_agent']; ?>,'.table-requsite_forms','sale_agent_<?php echo $agent['sale_agent']; ?>'); return false;"><?php echo $agent['full_name']; ?>
                  </a>
                </li>
                <?php } ?>
              </ul>
            ...
            <li class="active">
              <a href="#" data-cview="year_<?php echo $year['year']; ?>" onclick="dt_custom_view(<?php echo $year['year']; ?>,'.table-requsite_forms','year_<?php echo $year['year']; ?>'); return false;"><?php echo $year['year']; ?>
              </a>
            </li>
            <?php } ?>
            <?php } ?>
   ...
   <div class="col-md-12" id="small-table">
    <div class="panel_s">
     <div class="panel-body">
      ...
      <?php $this->load->view('admin/requsite_forms/table_html'); ?>
    </div>
  </div>
</div>
