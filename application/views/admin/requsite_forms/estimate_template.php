         ...
         <div class="col-md-6">
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <?php include_once(APPPATH .'views/admin/requsite_forms/billing_and_shipping_template.php'); ?>
               </div>
               <div class="col-md-6">
               ...
               <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    ?>
                    <?php echo render_custom_fields('requsite_form', $rel_id); ?>
                </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="panel_s no-shadow">
                ...
                $format = get_option('requsite_form_number_format');

                if(isset($estimate)){
                    $format = $estimate->number_format;
                }

                $prefix = get_option('requsite_form_prefix');
                ...
                <div class="form-group">
                    <label for="number"><?php echo _l('Requsite form Number'); ?></label>
                    <div class="input-group">
                  <span class="input-group-addon">
                  <?php if(isset($estimate)){ ?>
                      <a href="#" onclick="return false;" data-toggle="popover" data-container='._transaction_form' data-html="true" data-content="<label class='control-label'><?php echo _l('settings_sales_estimate_prefix'); ?></label><div class='input-group'><input name='s_prefix' type='text' class='form-control' value='<?php echo $estimate->prefix; ?>'></div><button type='button' onclick='save_sales_number_settings(this); return false;' data-url='<?php echo admin_url('requsite_forms/update_number_settings/'.$estimate->id); ?>' class='btn btn-info btn-block mtop15'><?php echo _l('submit'); ?></button>"><i class="fa fa-cog"></i></a>
                  <?php }
                  echo $prefix;
                  ?>
                 </span>
                        <input type="text" name="number" readonly class="form-control" value="<?php echo $_estimate_number; ?>" data-isedit="<?php echo $isedit; ?>" data-original-number="<?php echo $data_original_number; ?>">
                        <?php if($format == 3) { ?>
                            <span class="input-group-addon">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <?php echo render_date_input('date','Requsite form Date',$value); ?>
                    </div>
                    <div class="col-md-4">
                        <?php
                        $selected = '';
                    ...
                    <div class="col-md-4">
                        <?php
                        $statuses = [
                            ['id' => 1, 'name' => 'Delay due to Customer'],
                            ['id' => 2, 'name' => 'Delay due to Engineer'],
                            ['id' => 3, 'name' => 'Delay due to Principal'],
                            ['id' => 4, 'name' => 'Clarification Required'],
                            ['id' => 5, 'name' => 'Canceled'],
                            ['id' => 7, 'name' => 'Pending'],
                        ];
                        echo render_select('status',$statuses,array('id','name'),'estimate_status', (isset($estimate->status) ? $estimate->status : 7 ));
                        ?>
                    </div>
                    <div class="col-md-12">
...
<!--                  <div class="col-md-6">-->
                     <?php
                        ...
                        ?>
                     <?php echo render_select('currency',$currencies,array('id','name','symbol'),'estimate_add_edit_currency',$selected,$s_attrs,'','hidden'); ?>
<!--                  </div>-->
                   <!--<div class="col-md-6">
                     <div class="form-group select-placeholder">
   ...
   <?php $this->load->view('admin/requsite_forms/_add_edit_items'); ?>
