...
$sTable       = 'tblcontacts';
$join         = [];
array_push($join,'LEFT JOIN tbldivision  ON tblcontacts.division = tbldivision.id ');
...
$where = ['AND tblcontacts.userid=' . $client_id];
...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, ['tblcontacts.id as id', 'tblcontacts.userid', 'is_primary']);
