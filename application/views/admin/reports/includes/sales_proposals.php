   ...
   <table class="table table-proposals-report scroll-responsive">
      <thead>
         <tr>
            ...
            <th><?php echo _l('report_proposal_total_tax'); ?></th>
            <th><?php echo _l('report_proposal_igst'); ?></th>
            <th><?php echo _l('report_proposal_cgst'); ?></th>
            <th><?php echo _l('report_proposal_sgst'); ?></th>
            ...
            <!--<th><?php //echo _l('estimate_adjustment'); ?></th>
			 <th><?php //echo _l('invoice_transportation'); ?></th>-->
		   <th><?php echo _l('invoice_servicecharge'); ?></th>
		   <th><?php echo _l('invoice_packing_and_forwarding'); ?></th>		
