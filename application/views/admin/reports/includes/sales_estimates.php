      ...
      <table class="table table-estimates-report scroll-responsive">
         <thead>
          <tr>
            ...
            <th><?php echo _l('report_estimates_gst'); ?></th>
            <th><?php echo _l('report_estimates_igst'); ?></th>
            <th><?php echo _l('report_estimates_cgst'); ?></th>
            <th><?php echo _l('report_estimates_sgst'); ?></th>
            ...
            <th><?php //echo _l('estimate_transportation'); ?></th>-->
            <th><?php echo _l('estimate_servicecharge'); ?></th>
            <th><?php echo _l('estimate_packing_and_forwarding'); ?></th>
