  <div id="items-transaction-report" class="hide">
...
--><?php /*} */?>
  <table class="table table-items-transaction-report scroll-responsive">
    <thead>
      <tr>
        <th><?php echo _l('reports_item'); ?></th>
        <th><?php echo _l('Description'); ?></th>
        <th><?php echo _l('Purchased'); ?></th>
        <th><?php echo _l('Sold'); ?></th>
        <th><?php echo _l('Profit and/or Loss'); ?></th>
        <th><?php echo _l('Stock(Qty) Amt'); ?></th>
      </tr>
    </thead>
    <tbody>
