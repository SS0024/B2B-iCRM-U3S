                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="division"><small class="req text-danger">* </small><?php echo 'Division'; ?></label>
                            <select class="selectpicker" data-none-selected-text="<?php echo _l('system_default_string'); ?>" data-width="100%" name="division" id="division">
                                <option value="">Select Division</option>
                                <?php
                                foreach($divisions as $division){
                                    $value=( isset($contact) ? $contact->division : '');
                                    ...
                                    ?>
                                    <option value="<?php echo $division->id ?>" <?php echo $ddd;?>><?php echo $division->division ?></option>
                                <?php } ?>
