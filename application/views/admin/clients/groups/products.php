<?php if (isset($client)) { ?>
    ...
    <div class="_buttons">
        <?php if (has_permission('my_products', '', 'create')){ ?>
        <a href="#" class="btn btn-info mbot25 mleft5" data-toggle="modal"
           data-target="#new_products"><?php echo _l('New Products'); ?></a>
        <a href="<?php echo admin_url('invoice_items/import_customer_products'); ?>" class="btn btn-info pull-left "><?php echo _l('import'); ?></a>
        <?php } ?>
