...
<?php
  ...
  $table_data = array_merge($table_data, array(_l('client_email'),_l('contact_position'), "Division", _l('client_phonenumber'),_l('contact_active'),_l('clients_list_last_login')));
