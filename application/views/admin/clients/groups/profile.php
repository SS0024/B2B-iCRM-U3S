         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php } ?>
                   <?php $value=( isset($client) ? $client->price_hike : ''); ?>
                   <?php echo render_input( 'price_hike', 'Price Hike %',$value); ?>
                   <?php $value=( isset($client) ? $client->discount : ''); ?>
                   <?php echo render_input( 'discount', 'Discount %',$value); ?>
               </div>
               <div class="col-md-6">
