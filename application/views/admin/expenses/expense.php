...
<!--                  --><?php //echo render_input('expense_name','expense_name',$value); ?>
                  ...
                  <div class="form-group select-placeholder">
                     <label for="custome_clientid" class="control-label"><?php echo _l('expense_add_edit_customer'); ?></label>
                     <select id="custome_clientid" name="clientid" data-live-search="true" data-width="100%" class="ajax-search" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
...
<script>
   ...
   init_ajax_search('customer', '#custome_clientid.ajax-search','',admin_url+'clients/get_clients');
