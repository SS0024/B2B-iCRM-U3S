...
<div class="_filters _hidden_inputs hidden">
   ...
   if(isset($sale_agents)){
       foreach($sale_agents as $agent){
           echo form_hidden('sale_agent_'.$agent['addedfrom']);
       }
   }
...
<div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
    ...
    <ul class="dropdown-menu dropdown-menu-right width300">
        ...
        <?php if(count($sale_agents) > 0){ ?>
            <li class="divider"></li>
            <li class="dropdown-submenu pull-left">
                <a href="#" tabindex="-1"><?php echo _l('Added By'); ?></a>
                <ul class="dropdown-menu dropdown-menu-left">
                    <?php foreach($sale_agents as $agent){ ?>
                        <li>
                            <a href="#" data-cview="sale_agent_<?php echo $agent['addedfrom']; ?>" onclick="dt_custom_view(<?php echo $agent['addedfrom']; ?>,'<?php echo $filter_table_name; ?>','sale_agent_<?php echo $agent['addedfrom']; ?>'); return false;"><?php echo $agent['full_name']; ?>
                            </a>
                        </li>
                    <?php } ?>
                </ul>
