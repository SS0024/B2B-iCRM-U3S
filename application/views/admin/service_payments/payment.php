					...
					<div class="col-md-12 no-padding">
						<div class="panel_s">
							...
							<div class="panel-body">
								<h4 class="no-margin"><?php echo _l('payment_edit_for_invoice'); ?> <a href="<?php echo admin_url('service_invoices/list_invoices/'.$payment->invoiceid); ?>"><?php echo format_service_invoice_number($invoice->id); ?></a></h4>
						...
						<div class="pull-right">
							<div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li class="hidden-xs"><a href="<?php echo admin_url('service_payments/pdf/'.$payment->paymentid.'?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a></li>
									<li class="hidden-xs"><a href="<?php echo admin_url('service_payments/pdf/'.$payment->paymentid.'?output_type=I'); ?>" target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
									<li><a href="<?php echo admin_url('service_payments/pdf/'.$payment->paymentid); ?>"><?php echo _l('download'); ?></a></li>
									<li>
										<a href="<?php echo admin_url('service_payments/pdf/'.$payment->paymentid.'?print=true'); ?>" target="_blank">
											<?php echo _l('print'); ?>
										</a>
									</li>
								</ul>
								...
								<div class="col-md-12 mtop30">
									...
									<div class="table-responsive">
										<table class="table table-borderd table-hover">
											<thead>
												<tr>
													<th><?php echo 'Service '._l('payment_table_invoice_number'); ?></th>
													<th><?php echo 'Service '._l('payment_table_invoice_date'); ?></th>
													<th><?php echo 'Service '._l('payment_table_invoice_amount_total'); ?></th>
											...
											<tbody>
												<tr>
													<td><?php echo format_service_invoice_number($invoice->id); ?></td>
