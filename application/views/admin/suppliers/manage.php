...
<script>
    $(function () {
        ...
        var tAPI = initDataTable('.table-suppliers', admin_url + 'suppliers/table', [0], [0], CustomersServerParams,<?php echo do_action('customers_table_default_order', json_encode(array(2, 'asc'))); ?>);
    });
    ...
    function customers_bulk_action(event) {
        ...
        if (r == false) {
            ...
            var rows = $('.table-suppliers').find('tbody tr');
            $.each(rows, function () {
            ...
            setTimeout(function () {
                $.post(admin_url + 'suppliers/bulk_action', data).done(function () {
