...
<?php echo form_hidden('_attachment_sale_type','deliverychallan'); ?>
         ...
         <div class="horizontal-scrollable-tabs preview-tabs-top">
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                  ...
                  <!--<li role="presentation">
                     <a href="#tab_reminders" onclick="initDataTable('.table-reminders', admin_url + 'misc/get_reminders/' + <?php /*echo $invoice->id ;*/?> + '/' + 'deliverychallan', undefined, undefined,undefined,[1,'asc']); return false;" aria-controls="tab_reminders" role="tab" data-toggle="tab">
...
/*                        $total_reminders = total_rows('tblreminders',
                  ...
                  <li role="presentation" class="tab-separator">
                     <a href="#tab_notes" onclick="get_sales_notes(<?php echo $invoice->id; ?>,'delivery_challan'); return false" aria-controls="tab_notes" role="tab" data-toggle="tab">
         ...
         <div class="row">
            <div class="col-md-2">
               <?php echo format_delivery_challan_status($invoice->status,'mtop5'); ?>
            </div>
            <div class="col-md-10 _buttons">
               ...
               <div class="pull-right">
                   ...
                   if($invoice->purchaseorder_id){
                       echo '<a href="'.admin_url('purchaseorder/list_purchaseorder/'.$invoice->purchaseorder_id).'" class="btn btn-info" target="_blank">'.format_purchaseorder_number($invoice->purchaseorder_id).'</a>';
                   }
                   ?>
                  <?php
                     ...
                     ?>
                  <?php if(has_permission('delivery_challan','','edit')){ ?>
                  <a href="<?php echo admin_url('delivery_challan/invoice/'.$invoice->id); ?>" data-toggle="tooltip" title="<?php echo _l('edit_invoice_tooltip'); ?>" class="btn btn-default btn-with-tooltip" data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
                  <div class="btn-group">
                     <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-file-pdf-o"></i><?php if(is_mobile()){echo ' PDF';} ?> <span class="caret"></span></a>
                     <ul class="dropdown-menu dropdown-menu-right">
                        <li class="hidden-xs"><a href="<?php echo admin_url('delivery_challan/pdf/'.$invoice->id.'?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a></li>
                        <li class="hidden-xs"><a href="<?php echo admin_url('delivery_challan/pdf/'.$invoice->id.'?output_type=I'); ?>" target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
                        <li><a href="<?php echo admin_url('delivery_challan/pdf/'.$invoice->id); ?>"><?php echo _l('download'); ?></a></li>
                        <li>
                           <a href="<?php echo admin_url('delivery_challan/pdf/'.$invoice->id.'?print=true'); ?>" target="_blank">
                           <?php echo _l('print'); ?>
                           </a>
                        </li>
                     </ul>
				  ...
				  <!--<div class="btn-group">
						...
						<ul class="dropdown-menu dropdown-menu-right">
							<li class="hidden-xs"><a href="<?php /*echo admin_url('delivery_challan/pdf/'.$invoice->id.'?output_type=I&type=way_bill'); */?>"><?php /*echo _l('view_pdf'); */?></a></li>
							<li class="hidden-xs"><a href="<?php /*echo admin_url('delivery_challan/pdf/'.$invoice->id.'?output_type=I&type=way_bill'); */?>" target="_blank"><?php /*echo _l('view_pdf_in_new_window'); */?></a></li>
							<li><a href="<?php /*echo admin_url('delivery_challan/pdf/'.$invoice->id.'?type=way_bill'); */?>"><?php /*echo _l('download'); */?></a></li>
							<li>
							   <a href="<?php /*echo admin_url('delivery_challan/pdf/'.$invoice->id.'?print=true&type=way_bill'); */?>" target="_blank">
							   <?php /*echo _l('print'); */?>
							   </a>
							</li>
						</ul>
...
<!--                        <li><a href="--><?php //echo site_url('invoice/' . $invoice->id . '/' .  $invoice->hash) ?><!--" target="_blank">--><?php //echo _l('view_invoice_as_customer_tooltip'); ?><!--</a></li>-->
                        <!--<li>
                           ...
                           <a href="<?php /*echo admin_url('delivery_challan/send_overdue_notice/'.$invoice->id); */?>"><?php /*echo _l('send_overdue_notice_tooltip'); */?></a>
                           <?php /*} */?>
                        </li>-->
                        ...
                        <li>
                           <a href="<?php /*echo admin_url('delivery_challan/copy/'.$invoice->id); */?>"><?php /*echo _l('invoice_copy'); */?></a>
                        </li>
                        --><?php /*} */?>
                        <?php if($invoice->sent == 0){ ?>
                        <li>
                           <a href="<?php echo admin_url('delivery_challan/mark_as_sent/'.$invoice->id); ?>"><?php echo _l('invoice_mark_as_sent'); ?></a>
                        </li>
                        <?php } ?>
                        <?php if(has_permission('delivery_challan','','edit') || has_permission('delivery_challan','','create')){ ?>
                        <li>
                           <?php if($invoice->status != 2  && $invoice->status != 5){ ?>
                           <a href="<?php echo admin_url('delivery_challan/mark_as_invoiced/'.$invoice->id); ?>"><?php echo _l('invoice_mark_as',_l('Invoiced')); ?></a>
                           <?php } ?>
                        </li>
                        <li>
                           <?php if($invoice->status != 3 && $invoice->status != 5){ ?>
                           <a href="<?php echo admin_url('delivery_challan/mark_as_returned/'.$invoice->id); ?>"><?php echo _l('invoice_mark_as',_l('Returned')); ?></a>
                           <?php } ?>
                        </li>
                        <li>
                           <?php if($invoice->status != 5){ ?>
                           <a href="<?php echo admin_url('delivery_challan/mark_as_cancelled/'.$invoice->id); ?>"><?php echo _l('invoice_mark_as',_l('invoice_status_cancelled')); ?></a>
                           <?php } else if($invoice->status == 5) { ?>
                           <a href="<?php echo admin_url('delivery_challan/unmark_as_cancelled/'.$invoice->id); ?>"><?php echo _l('invoice_unmark_as',_l('invoice_status_cancelled')); ?></a>
                           <?php } ?>
                        </li>
                        <?php } ?>
                        ...
                        <li>
                           ...
                           <a href="<?php /*echo admin_url('delivery_challan/resume_overdue_reminders/'.$invoice->id); */?>"><?php /*echo _l('resume_overdue_reminders'); */?></a>
                           <?php /*} else { */?>
                           <a href="<?php /*echo admin_url('delivery_challan/pause_overdue_reminders/'.$invoice->id); */?>"><?php /*echo _l('pause_overdue_reminders'); */?></a>
                           <?php /*} */?>
                        </li>
                        --><?php /*} */?>
                        <?php
                           if((get_option('delete_only_on_last_invoice') == 1 && is_last_invoice($invoice->id)) || (get_option('delete_only_on_last_invoice') == 0)){ ?>
                        <?php if(has_permission('delivery_challan','','delete') && $invoice->is_stock_out != 2){ ?>
                        <li data-toggle="tooltip" data-title="<?php echo _l('delete_invoice_tooltip'); ?>">
                           <a href="<?php echo admin_url('delivery_challan/delete/'.$invoice->id); ?>" class="text-danger delete-text _delete"><?php echo _l('delete_invoice'); ?></a>
                        </li>
                        <?php } ?>
                        <?php } ?>
                     </ul>
                  ...
                  --><?php /*} */
                   if($invoice->is_stock_out != 2){
                       ?>
                       <a href="<?php echo admin_url('delivery_challan/stock_out/'.$invoice->id); ?>" data-toggle="tooltip" title="Stock In" class="btn btn-default btn-with-tooltip" data-placement="bottom">Stock Out</a>
                   <?php } ?>
               </div>
            </div>
         </div>
         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab_invoice">
               ...
               <?php } ?>
               <?php $this->load->view('admin/delivery_challan/invoice_preview_html'); ?>
            </div>
            <?php if(count($invoice->payments) > 0) { ?>
            <div class="tab-pane" role="tabpanel" id="invoice_payments_received">
               <?php include_once(APPPATH . 'views/admin/delivery_challan/invoice_payments_table.php'); ?>
            </div>
            <?php } ?>
            <?php if(count($applied_credits) > 0){ ?>
                                ...
                                <table class="table items estimate-items-preview">
                                    ...
                                    foreach($invoices_delivery_modules as $invoices_delivery_module) {  ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo admin_url('/delivery_challan/list_invoices/'.$invoices_delivery_module['invoice_id']);?>" target="_blank"><?php echo $invoices_delivery_module['sale_reference_no']; ?></a>
                                            </td>
            ...
            <div role="tabpanel" class="tab-pane" id="tab_child_invoices">
               ...
               <ul class="list-group">
                  ...
                  <li class="list-group-item">
                     <a href="<?php echo admin_url('delivery_challan/list_invoices/'.$recurring->id); ?>" onclick="init_invoice(<?php echo $recurring->id; ?>); return false;" target="_blank"><?php echo format_delivery_challan_number($recurring->id); ?>
...
<!--                     --><?php //echo format_delivery_challan_status($recurring->status,'',false); ?>
                     </span>
                  </li>
                  <?php } ?>
               </ul>
            ...
            <div role="tabpanel" class="tab-pane" id="tab_notes">
               <?php echo form_open(admin_url('delivery_challan/add_note/'.$invoice->id),array('id'=>'sales-notes','class'=>'invoice-notes-form')); ?>
                                 ...
                                 if(!empty($activity['additional_data'])){
                                  ...
                                  foreach($additional_data as $data){
                                    if(strpos($data,'<original_status>') !== false){
                                      ...
                                      $additional_data[$i] = format_delivery_challan_status($original_status,'',false);
                                    } else if(strpos($data,'<new_status>') !== false){
                                      $new_status = get_string_between($data, '<new_status>', '</new_status>');
                                      $additional_data[$i] = format_delivery_challan_status($new_status,'',false);
...
<?php $this->load->view('admin/delivery_challan/invoice_send_to_client'); ?>
