...
if(count($invoices_to_merge) > 0){ ?>
    ...
    <div class="checkbox">
        ...
        <label for=""><a href="<?php echo admin_url('delivery_challan/list_invoices/'.$_inv->id); ?>" data-toggle="tooltip" data-title="<?php echo format_delivery_challan_status($_inv->status,'',false); ?>" target="_blank"><?php echo format_invoice_number($_inv->id); ?></a> - <?php echo format_money($_inv->total,$_inv->symbol); ?></label>
    </div>
