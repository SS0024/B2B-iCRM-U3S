<div id="stats-top" class="hide">
  ...
  <div class="panel_s mtop20">
    ...
    <div class="col-lg-5ths col-md-5ths">
      <div class="row">
        <div class="col-md-7">
          <!--<a href="#" data-cview="invoices_<?php /*echo $status; */?>" onclick="dt_custom_view('invoices_<?php /*echo $status; */?>','.table-delivery_challans','invoices_<?php /*echo $status; */?>',true); return false;">
            <h5><?php /*echo format_delivery_challan_status($status,'',false); */?></h5>
          </a>-->
        </div>
