        ...
        <tbody>
            ...
            <tr class="payment">
                ...
                <td>
                    ...
                    <a href="<?php echo admin_url('delivery_challan/delete_payment/'.$payment['paymentid'] . '/' . $payment['invoiceid']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                    <?php } ?>
                </td>
            </tr>
            <?php } ?>
