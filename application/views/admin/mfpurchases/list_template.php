<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons erer">
         ...
         <?php if(has_permission('mfpurchases','','create')){ ?>
            <a href="<?php echo admin_url('mfpurchases/mfpurchase'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('Add new indent'); ?></a>
         <?php } ?>
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/mfpurchases/table_html'); ?>
            </div>
         </div>
      </div>
