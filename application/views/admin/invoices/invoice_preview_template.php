         ...
         <div class="horizontal-scrollable-tabs preview-tabs-top">
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                  ...
                  <?php } ?>
                   <?php if(has_permission('deliveries','','view')){ ?>
                   <li role="presentation">
               ...
               <div class="pull-right">
                  ...
                  <div class="btn-group">
                     ...
                     <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li>
                        <li><a href="<?php echo admin_url('invoices/pipdf/'.$invoice->id); ?>"><?php echo "Download PI"; ?></a></li>
                        <li>
                  ...
                  <!-- Single button -->
				  <!-- Delivery Bill -->
                   <?php if(has_permission('deliveries','','create')){ ?>
				  <a href="<?php echo admin_url('invoices/delivery_details/'.$invoice->id); ?>" data-toggle="tooltip" title="<?php echo _l('delivery_details_tooltip'); ?>" class="btn btn-primary btn-with-tooltip" data-placement="bottom"><!-- <?php echo _l('delivery'); ?> --><i class="fa fa-truck"></i></a>
                   <?php } ?>
				  ...
				  <!--<div class="btn-group">
						...
						<ul class="dropdown-menu dropdown-menu-right">
							<li class="hidden-xs"><a href="<?php /*echo admin_url('invoices/pdf/'.$invoice->id.'?output_type=I&type=way_bill'); */?>"><?php /*echo _l('view_pdf'); */?></a></li>
							<li class="hidden-xs"><a href="<?php /*echo admin_url('invoices/pdf/'.$invoice->id.'?output_type=I&type=way_bill'); */?>" target="_blank"><?php /*echo _l('view_pdf_in_new_window'); */?></a></li>
							<li><a href="<?php /*echo admin_url('invoices/pdf/'.$invoice->id.'?type=way_bill'); */?>"><?php /*echo _l('download'); */?></a></li>
							<li>
							   <a href="<?php /*echo admin_url('invoices/pdf/'.$invoice->id.'?print=true&type=way_bill'); */?>" target="_blank">
							   <?php /*echo _l('print'); */?>
							   </a>
							</li>
						</ul>
                  ...
                  <div class="btn-group">
                     ...
                     <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <?php if(has_permission('invoices','','delete') && $invoice->is_stock_out != 2){ ?>
