         ...
         <tbody>
            ...
            <tr>
              ...
              <!-- <tr>
               ...
               <tr>
                   <td><span class="<?php if($invoice->total_left_to_pay > 0){echo 'text-danger ';} ?>bold">PO <?php echo _l('invoice_amount_due'); ?></span></td>
                   <td>
                 <span class="<?php if($invoice->total_left_to_pay > 0){echo 'text-danger';} ?>">
                    <?php echo format_money(get_purchaseorder_total_left_to_pay($invoice->purchaseorder_id, $invoice->total), $invoice->symbol); ?>
                 </span>
                   </td>
               </tr>
               <tr>
