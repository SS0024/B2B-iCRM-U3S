...
class Misc extends Admin_controller
{
    ...
    public function get_suppliers_dropdown_template()
    {
        $item_key = $this->input->post('item_key');
        $supplierid = $this->input->post('supplierid');
        echo $this->misc_model->get_suppliers_dropdown_template($item_key, $supplierid);
    }

    public function get_item_group_dropdown_for_mfitems()
    {
        $item_key = $this->input->post('item_key');
        $group_id= $this->input->post('group_id');
        echo $this->misc_model->get_item_group_dropdown_for_mfitems($item_key, $group_id);
    }

    public function get_item_group_dropdown_template()
    {
        $group_id= $this->input->post('group_id');
        echo $this->misc_model->get_item_group_dropdown_template($group_id);
    }
