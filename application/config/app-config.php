...
*
*/
 define('APP_BASE_URL', 'http://localhost/clients/u3s-engitech/u3s-crm-280821/');
//define('APP_BASE_URL', 'http://192.168.29.192/u3s_crm/');
...
*/
define('APP_ENC_KEY', '839a3b1b7419a2a9002c41740434786a');
...
define('APP_DB_NAME', 'clients_u3s_crm');
