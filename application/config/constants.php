...
define('INQUIRY_ATTACHMENTS_FOLDER', FCPATH . 'uploads/inquiry' . '/');
// requsite_form attachments
define('REQUSITE_FORM_ATTACHMENTS_FOLDER', FCPATH . 'uploads/requsite_forms' . '/');
define('PO_ATTACHMENTS_FOLDER', FCPATH . 'uploads/purchaseorder' . '/');
...
// Delivery Modules attachments
define('DELIVERY_MODULES_FOLDER', FCPATH . 'uploads/delivery_modules' . '/');

// Invoice Payments attachments
define('INVOICE_PAYMENT_TEMP_FOLDER', FCPATH . 'uploads/invoice_payment_temp' . '/');
define('INVOICE_PAYMENT_FOLDER', FCPATH . 'uploads/invoice_payment' . '/');

if (!defined('SERVICE_CHARGES_TAX_RATE')) {
    define('SERVICE_CHARGES_TAX_RATE', 18.00);
}
