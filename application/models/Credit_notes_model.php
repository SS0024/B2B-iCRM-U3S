...
class Credit_notes_model extends CRM_Model
{
    ...
    */
    ...
    public function credit_note_from_invoice($invoice_id)
    {
        ...
        $new_credit_note_data['devide_gst']            = $_invoice->devide_gst;
        ...
        $new_credit_note_data['packing_and_forwarding']   = $_invoice->packing_and_forwarding;
        $new_credit_note_data['servicecharge']   = $_invoice->servicecharge;
        ...
        foreach ($_invoice->items as $item) {
            ...
            $new_credit_note_data['newitems'][$key]['item_discount'] = $item['item_discount'];
            $new_credit_note_data['newitems'][$key]['group_id'] = $item['group_id'];
            $new_credit_note_data['newitems'][$key]['item_amount'] = $item['item_amount'];
