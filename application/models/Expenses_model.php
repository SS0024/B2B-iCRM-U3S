...
class Expenses_model extends CRM_Model
{
    ...
    {
        return $this->db->query("SELECT DISTINCT(addedfrom) as addedfrom, CONCAT(firstname, ' ', lastname) as full_name FROM tblexpenses JOIN tblstaff on tblstaff.staffid=tblexpenses.addedfrom WHERE addedfrom != 0")->result_array();
    }
