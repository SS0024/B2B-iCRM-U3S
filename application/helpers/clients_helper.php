...
function get_customer_profile_tabs($customer_id)
{
    $customer_tabs = [
        ...
        [
            'name'    => 'division',
            'url'     => admin_url('clients/client/' . $customer_id . '?group=division'),
        ...
        [
            'name' => 'Credit Module',
            'url' => admin_url('clients/client/' . $customer_id . '?group=credit_module'),
            'icon' => 'fa fa-sticky-note-o',
            'lang' => _l('Credit Module'),
            'visible' => true,
            'order' => 4,
        ],
        [
        ...
        [
            'name' => 'products',
            'url' => admin_url('clients/client/' . $customer_id . '?group=products'),
